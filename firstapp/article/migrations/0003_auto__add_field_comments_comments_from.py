...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comments.comments_from'
        db.add_column('comments', 'comments_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comments.comments_from'
        db.delete_column('comments', 'comments_from_id')
    ...
    models = {
        ...
        u'article.comments': {
            ...
            'comments_from': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
